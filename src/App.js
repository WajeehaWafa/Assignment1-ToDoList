...
<form onSubmit={ handleaddFormsubmit} >
        <label>Todos</label>
        <input type ='text' placeholder="Enter todo" name ='name' value={todo} onChange={taskenter}/>
      ...
      <form onSubmit={handleEditedformsubmit}>
        ...
        {tododata.map((contact)=>(
          <Fragment> 
            ...
            <ReadOnlyRow isComplete={ contact.completed } contact={contact} handleEditClick={handleEditClick} del={del} Complete={Complete} />
            ) 
          }
          </Fragment>
